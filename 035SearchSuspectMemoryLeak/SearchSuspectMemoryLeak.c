	...
	do {
		...
		while (1) {
			if (yes_no(current->question))
			{
				...
				//free (current->question);current->question уже указывает на что-то находящееся в куче нам нужно освободить это место до того как выделять новое под новый вопрос  
