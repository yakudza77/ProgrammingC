...
int main() {
	...
	struct fish Baron = { .name = "Baron",.age = 15,.care.exercise.description = "like jumping over the hoop",.species="dolphin"};
	//ѕример выборочной записи данных во вложенные структуры,можно записать в любой последовательности и пропускать пол€
